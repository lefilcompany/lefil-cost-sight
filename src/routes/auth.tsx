    ...
    <div className="grid min-h-screen w-full bg-background lg:grid-cols-2">
      ...
      >
        ...
        <div className="relative flex items-center gap-3">
          <img src={quiwiLogo.url} alt="Quiwi" className="h-14 w-auto object-contain" />
        </div>
        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Somente contas Google com e-mail
              <br /><span className="font-medium text-foreground">@lefil.com.br</span>&nbsp;podem entrar.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-border/60 bg-muted/30 p-4">
            <div className="flex items-start gap-3">
              <div className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-[color:var(--emerald-deep)]/10 text-[color:var(--emerald-deep)]">
                <ShieldCheck className="h-4 w-4" />
              </div>
              <div className="space-y-1">
                <p className="text-xs font-semibold">Aprovação obrigatória</p>
                <p className="text-[11px] leading-relaxed text-muted-foreground">
                  Novos acessos ficam pendentes até que um administrador aprove a entrada no painel.
                </p>
              </div>
            </div>
          </div>
